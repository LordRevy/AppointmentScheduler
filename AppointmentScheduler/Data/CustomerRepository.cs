    ...
    public class CustomerRepository : Database
    {
        ...
        private static Customer MapCustomer(OdbcDataReader r)
        {
            return new()
            {
                ...
                Name = Convert.ToString(r["customerName"]) ?? "MISSING DATA",
                Address = Convert.ToString(r["address"]) ?? "MISSING DATA",
                Phone = Convert.ToString(r["phone"]) ?? "MISSING DATA"
            };
        }
        ...
        public void Delete(Customer c)
        {
            ...
            const string deleteCustomerSql = "DELETE FROM customer WHERE customerId = ?;";
